            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('activity', $activities->pluck('activityName', 'id'), null, ['class' => 'form-control'.(!$errors->has('activity') ? '': ' is-invalid '), 'placeholder' => '------']) !!}
                        @include('components.error', ['field' => 'activity'])
                    </div>
                    <div class="form-group">
                        {!! Form::label('target_group', 'Target group') !!}
                        {!! Form::select('target_group', \App\Event::getTargetGroup(), null, ['class' => 'form-control'.(!$errors->has('target_group') ? '': ' is-invalid '), 'placeholder' => '------']) !!}
